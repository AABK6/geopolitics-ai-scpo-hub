...
1. **The 3D Hub:** The landing page map showing how the theoretical modules and student research projects connect.
...
If your group wants to use AI coding agents (Cursor, Windsurf, Copilot) or build a more complex app (React, Vue, Three.js), you have full freedom to do so:
